                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Symptoms List
                                            ...
                                            @foreach ($symptoms as $key => $symptom)
                                                <tr>
                                                    ...
                                                    <td class="table-action">
                                                        <a href="#" class="align-middle fas fa-fw fa-pen edit" title="Edit" data-toggle="modal" data-target="#defaultModalPrimary" id={{$symptom->id}}></a>
                                                        <a href="#" data-toggle="modal" data-target="#confirmation" onclick="delete_id={{$symptom->id}};"><i class="align-middle fas fa-fw fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        <form id="modal-form" action="{{url('symptoms/save')}}" method="post">
                            @csrf
                        <div class="form-group col-md-12">
                            <label for="name">Name</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Symptoms Name" required>
                        </div>
                        <div class="form-group col-md-12">
    ...
    <script>
        ...
        $(function() {
            ...
            $('.add').click(function(){
                ...
                $('#modal-form').attr('action', 'symptoms/save');
            })
        });
